...
/**
 * Created by zhaopan on 2015/8/12 16:45
 * e-mail: kangqiao610@gmail.com
 * 日期工具类, 如果需要识别特殊的日期, 请在enum DateStyle 增加你需要的格式即可
 */
public class DateUtil {
	...
	public static Date milliToDate(String milli){
        long milliseconds = ArithUtil.toLong(milli);
        return new Date(milliseconds);
    }

    public static Date secondToDate(String second){
        long milliseconds = ArithUtil.toLong(second) * 1000;
        return new Date(milliseconds);
    }
	...
	public static boolean isCurrentMoth(String date) {
		return DateUtil.DateToString(new Date(), DateStyle.YYYY_MM_MY1).equals(DateUtil.StringToString(date, DateStyle.YYYY_MM_MY1));
	}
    ...
    public enum Week {
        ...
        Week(String name_cn, String name_en, String name_enShort, String name_alias, int number) {
